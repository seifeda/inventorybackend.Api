    ...
    public partial class supplier : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "IsActive", "LastLogin", "LastName", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2025, 5, 22, 8, 58, 40, 297, DateTimeKind.Utc).AddTicks(6908), "admin@example.com", "Admin", true, null, "User", "$2a$11$TNFG38TuQQhxEDHKARrKP.xAWzixce0kXOVIURst6H924Dx7UbI3a", "Admin", "admin" });
